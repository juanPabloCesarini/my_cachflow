            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo RUTA_URL;?>/TareaController/GuardarCambiosTarea" method="post">
                                <div class="row">
                                    <div class="col-4">
                                    <label for="exampleFormControlTextarea1" class="form-label">Titulo</label>
                                        <input name="titulo" class="form-control form-control-lg" type="text"
                                            placeholder="<?php echo $data['tarea']->titulo;?>" aria-label=".form-control-lg example">
                                    </div>
                                    <div class="col-4">
                                    <label for="exampleFormControlTextarea1" class="form-label">Estado</label>
                                        <select name="id_estado" class="form-select form-select-lg mb-3"
                                            ...
                                            <option <?php if($est->id == $data['tarea']->fk_id_estado):?>selected<?php endif;?> style="color:<?php echo $est->color;?>"
                                    ...
                                    <?php $fecha_formateada=date('Y-m-d',strtotime($data['tarea']->expired_at));?>
                                        <input name="expired_at" class="form-control form-control-lg" type="date"
                                            value="<?php echo $fecha_formateada;?>" aria-label=".form-control-lg example">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Descripcion de
                                            tarea</label>
                                        <textarea name="descripcion" class="form-control form-control-lg"
                                            id="exampleFormControlTextarea1" rows="3"><?php echo $data['tarea']->descripcion;?></textarea>
                                    </div>
                                </div>
                                <div class="row">
